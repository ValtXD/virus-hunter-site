...
> Uma plataforma gamificada desenvolvida para transformar a educação científica e combater a desinformação na saúde pública por meio da estratégia em tempo real.
...
* **Sistemas de Defesa Orgânicos:** Divisão tática do jogo em ambientes biológicos, como a Fase 1 (Camada Epitelial/Pele) e a Fase 2 (Sistema Respiratório/Pulmões). As regras de combate mimetizam dados reais de patógenos e componentes imunológicos.
...
* **Inteligência Artificial Heurística:** O jogo implementa uma IA capaz de "ler" o cenário montado pelo jogador e escolher invasores específicos para quebrar a defesa. Por exemplo, a IA enviará o Poluente impenetrável caso o jogador não possua Macrófagos Alveolares, ou utilizará o Alérgeno como "isca" para forçar o gasto de habilidades.
...
* Conclusão do GDD (*Game Design Document*) com o mapeamento completo das tabelas de atributos de defesa e patógenos.
...
* Validação de conceito original apresentada no evento "Ocean Game JAM", realizado no Samsung Ocean Manaus.

---

##  Referências Bibliográficas Base

O arcabouço teórico do **Vírus Hunter** apoia-se em estudos acadêmicos recentes sobre a eficácia de jogos no ensino em saúde e ciências:
* **Immuno Rush:** MACHADO, C. T.; CARVALHO, A. *Immuno Rush: análise de um serious game sobre Imunologia*. Revista Tecnologias na Educação, v. 10, n. 25, julho de 2018.
* **A Trilha da Vacina:** AZEVEDO, I. M. F. et al. *A Trilha da Vacina: o uso da gamificação como abordagem estratégica para a construção do conhecimento em Imunologia na educação básica*.
* **Gamificação no Ensino Superior de Saúde:** TAKENAMI, I.; PALÁCIO, M. A. V. *Hepatitis Game: integração da gamificação como estratégia de aprendizagem no ensino superior em saúde*. UNIVASF, 2020.
* **Mecânica Tower Defense e Educação:** AUNGST, M. T. *Gamification of Antibiotic Education - Tower Defense Anyone?*.
